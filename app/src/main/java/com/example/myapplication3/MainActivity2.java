...
public class MainActivity2 extends AppCompatActivity {
    ...
    class QueryUtils extends AsyncTask<URL, Void, ArrayList<Youtube_viedo>> {
        private  final String Youtube_URL = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=25&playlistId="+MainActivity2.getPlaylist()+"&key=AIzaSyCGkUWYF0uCkbcxxcwc_Lua8njXVfvLz_U";
